...
class Product(models.Model):
    ...
    colors = models.CharField(max_length=100, default="separate colors by comma")
    ...
    old_price = models.IntegerField(default="none", null=True, blank=True)

    
    stock_count = models.CharField(max_length=100, default="", null=True, blank=True)
